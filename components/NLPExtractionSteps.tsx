  ...
  const [steps, setSteps] = useState<Step[]>([
    {
      ...
      description:
        "Mengidentifikasi nama tempat, koordinat, dan landmark dari teks laporan",
    ...
    },
    {
      ...
      description:
        "Menganalisis teks untuk menentukan kategori dan tingkat keparahan keadaan darurat",
    ...
    },
    {
      ...
      description:
        "Memverifikasi kelengkapan informasi dan konsistensi data laporan",
    ...
    <div className="space-y-4">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600">
          Sistem sedang menganalisis laporan Anda menggunakan Natural Language
          Processing
        </p>
      </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-grow">
                <div className="flex items-center space-x-2 mb-1">
                  <div className="p-1 rounded bg-blue-100">{step.icon}</div>
                  <h4
                    className={cn(
