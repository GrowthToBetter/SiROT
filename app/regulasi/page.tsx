...
const featuredRegulations = [
  {
    ...
    description:
      "Undang-undang dasar tentang sistem penanggulangan bencana nasional",
    url: "#",
  },
  {
    category: "SOP",
  ...
  },
  {
    ...
    title: "Prosedur Pelaporan Darurat",
...
export default function RegulasiPage() {
  const [selectedDocument, setSelectedDocument] =
    useState<RegulationDoc | null>(null);
  ...
  const getCategoryColor = (category: string) => {
    const colors: Record<string, string> = {
      ...
      "Prosedur Laporan": "bg-indigo-100 text-indigo-800 border-indigo-200",
    };
            ...
            {featuredRegulations.map((regulation, index) => (
              <div key={index} className="disaster-card group cursor-pointer">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Scale className="h-5 w-5 text-gray-400 group-hover:text-blue-600 transition-colors duration-200" />
                </div>
          ...
          <div className="disaster-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Peraturan perundang-undangan tingkat nasional tentang
                  kedaruratan
                </p>
              ...
              <div className="text-center p-6 bg-cyan-50 rounded-lg border border-cyan-200">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">SOP</h3>
                <p className="text-sm text-gray-600 mb-4">
              ...
              {[
                {
                  ...
                  date: "15 Jan 2024",
                  summary:
                    "Revisi prosedur evakuasi untuk bangunan bertingkat tinggi",
                },
                {
                  ...
                  date: "12 Jan 2024",
                  summary:
                    "Implementasi sistem pelaporan berbasis aplikasi mobile",
                },
                {
                  ...
                  date: "8 Jan 2024",
                  summary:
                    "Revisi alokasi dana dan mekanisme pencairan untuk tanggap darurat",
                },
              ].map((update, index) => (
                <div
                  key={index}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  <div className="text-sm text-gray-500">
                    Dipublikasikan:{" "}
                    {selectedDocument.createdAt.toLocaleDateString("id-ID", {
                      year: "numeric",
                      month: "long",
                      day: "numeric",
                    })}
